...
> **Integration correction:** the first Phase-2 commit omitted `xvc/data/`
> because `.gitignore` used an unanchored `data/` rule. The phone-aware branch
> root-anchors local-data ignores and restores the documented data package;
> see `MIGRATION.md`.
