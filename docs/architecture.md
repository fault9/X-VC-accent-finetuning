...
| — data | `xvc/data/` | versioned schemas, cross-pair validation, and reusable phone-supervision helpers |
...
| Phone-aware AccentBridge | same causal residual editor | pristine native timeline + MFA-indexed phone realization loss |
