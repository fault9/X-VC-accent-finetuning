...
cat "$archive.sha256"
echo "Next: upload/extract the archive beside the X-VC repo, then run"
echo "  SOURCE_ALIGN_DIR=$SOURCE_ALIGN_DIR TARGET_ALIGN_DIR=$TARGET_ALIGN_DIR \\"
echo "  bash scripts/run_phoneaware_accentbridge_sweep.sh"
